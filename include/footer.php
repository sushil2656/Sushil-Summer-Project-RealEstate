<footer class="full-row bg-secondary p-0">
            <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-4">
                                    <div class="footer-widget mb-4">
                                        ...
                                        <p class="pb-20 text-white">Welcome to Birauta Real Estate & Housing Pvt Ltd, your premier real estate partner in Birauta -17, Pokhara, Nepal. With a focus on integrity and personalized service, we're dedicated to helping you achieve your real estate goals. Whether you're buying, selling, or investing, trust us to guide you every step of the way. Let's turn your real estate dreams into reality..</p>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Baralfeed-17 Pokhara</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+977 98400567320</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+977 9876545678</li>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">© <?php echo date('Y');?> Real Estate Website - Developed By Sushil Poudel</span> </div>
                    <div class="col-sm-6">
