...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" style="background-image: url('images/banner/Nepal1.jpg'); background-size: cover; background-position: center center; background-repeat: no-repeat;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Sell your property seamlessly with expert pricing strategies and comprehensive marketing plans tailored to your needs at Birauta Real Estate.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>TSearch for quality rental properties in desirable locations with user-friendly search features on Birauta Real Estate.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Discover curated property listings with detailed descriptions and photos on Birauta Real Estate, making it easy to find your perfect match</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
								<i class="flaticon-diagram text-success flat-medium" aria-hidden="true"></i>
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Buying Service</a></h5>
                                <p>Find your dream home with personalized search options, financing guidance, and expert advice from Birauta Real Estate.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
									...
									<?php $query=mysqli_query($con,"SELECT property.*, user.uname,user.utype,user.uimage FROM `property`,`user` WHERE property.status != 0 and property.uid=user.uid ORDER BY date DESC LIMIT 9"); // pade
                                    ...
                                    <div class="col-md-6 col-lg-4"><!-- FOR MORE PROJECTS visit: freeprojectscodes.com -->
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b> रु<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> Sqft</span></div>
                                            </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Birauta Real Estate stands out as a top-rated choice in the industry, consistently delivering excellence and earning the trust of our clients through exceptional service and results</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>At Birauta Real Estate, quality isn't just a promise, it's our standard. From start to finish, our dedicated team provides unwavering support and guidance, ensuring your satisfaction every step of the way</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>With Birauta Real Estate, you gain access to a team of seasoned professionals whose extensive experience ensures a smooth and successful real estate journey, no matter the complexity</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>At Birauta Real Estate, we kick off the process with a personalized discussion between our agents and buyers. We listen closely to understand your needs, preferences, and budget, ensuring a tailored approach to finding your ideal property</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Next, our team conducts a thorough review of available properties that match your criteria. We leverage our network and databases to curate a selection of options that meet your needs, saving you time and effort in the property search.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once you've found the perfect property, we guide you through the acquisition process with expertise and professionalism. From negotiation to closing, we're with you every step of the way, ensuring a smooth and successful transaction</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/Pokhara.jpg" alt="">
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/kathmandu.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/chitwan.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/butwal-1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
